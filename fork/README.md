...
The current formal generation, deployed independently to Mini and imile-win, is documented in [`releases/v0.5.0-main.20260918.md`](releases/v0.5.0-main.20260918.md). The prior [`releases/v0.4.37-main.20260901.md`](releases/v0.4.37-main.20260901.md) remains rollback and historical evidence. The earlier [`v0.4.36-main.20260901`](releases/v0.4.36-main.20260901.md) manifest is retained as historical deployment evidence with an explicit identity correction notice.
