      ...
      entries: [
        {
          version: "0.3.29",
          date: "2026-06-24",
          title: "오토파일럿, Feishu 협업, 런타임 출시 안정성 개선",
          changes: [],
          features: [
            "Feishu 대화가 공통 연동 기반에서 동작해 메시지 처리가 더 일관되고, 앞으로 더 많은 채팅 채널을 붙이기 쉬워졌습니다.",
            "기능 출시 제어가 앱 동작과 데몬 동작까지 확장되어, 민감한 변경을 더 안전하게 단계적으로 켤 수 있습니다.",
            "에이전트가 긴 Issue 토론을 읽을 때 해결된 스레드를 핵심 결론으로 접어 불필요한 컨텍스트를 줄일 수 있습니다.",
            "Feishu 사용자는 `/new` 명령으로 새 대화를 시작할 수 있고, Lark WebSocket 연결은 지정 프록시를 사용할 수 있습니다.",
          ],
          improvements: [
            "예약 오토파일럿은 놓친 일정, 재시도, 여러 실행자가 동시에 처리하는 상황에서도 의도한 한 번의 실행으로 더 안정적으로 수렴합니다.",
            "에이전트 런타임 안내를 출시 스위치 뒤에서 더 짧게 만들 수 있으며, 필요하면 기존의 자세한 안내로 되돌릴 수 있습니다.",
            "런타임 제공자 문서가 현재 지원 목록에 맞게 정리되었고, Qoder와 CodeBuddy 안내 및 Antigravity 설명이 보강되었습니다.",
            "프로젝트 저장소 설정의 체크아웃 대상이 로컬 에이전트 작업에도 반영됩니다.",
          ],
          fixes: [
            "부모 Issue 안의 하위 Issue가 생성 순서대로 안정적으로 표시됩니다.",
            "Issue 안의 동일 출처 첨부 파일 미리보기가 올바르게 열립니다.",
            "@멘션 선택기는 검색 결과 순서가 바뀌어도 현재 강조된 사람이나 Issue를 정확히 선택합니다.",
            "취소 후 되돌아온 채팅 초안은 삭제하고 화면을 이동해도 다시 나타나지 않습니다.",
            "오토파일럿 초기 실행, Issue 헤더의 에이전트 상태, Antigravity 제공자 오류 표시가 더 정확해졌습니다.",
          ],
        },
        {
          version: "0.3.28",
