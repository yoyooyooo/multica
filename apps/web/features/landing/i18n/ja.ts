      ...
      entries: [
        {
          version: "0.3.29",
          date: "2026-06-24",
          title: "オートパイロット、Feishu 連携、ランタイム展開の信頼性向上",
          changes: [],
          features: [
            "Feishu の会話が共通の連携基盤で動くようになり、メッセージ処理がより一貫し、今後のチャットチャネル追加に備えました。",
            "機能ロールアウトの制御がアプリとデーモンの動作にも広がり、影響の大きい変更を段階的に有効化しやすくなりました。",
            "エージェントが長い Issue 議論を読むとき、解決済みスレッドを有用な結論まで折りたためるようになりました。",
            "Feishu では `/new` コマンドで新しい会話を始められ、Lark WebSocket 接続には指定プロキシを使えます。",
          ],
          improvements: [
            "スケジュールされたオートパイロットは、取り逃し、再試行、複数ランナーの競合があっても意図した 1 回の実行に収束しやすくなりました。",
            "エージェントのランタイム説明はロールアウトスイッチの後ろで短くでき、必要な場合は従来の詳しい説明に戻せます。",
            "ランタイムプロバイダーのドキュメントを現在の対応状況に合わせ、Qoder と CodeBuddy の案内、Antigravity の補足を更新しました。",
            "プロジェクトのリポジトリ設定で指定したチェックアウト先が、ローカルエージェント作業にも反映されます。",
          ],
          fixes: [
            "親 Issue 内の子 Issue は作成順で安定して表示されます。",
            "Issue 内の同一オリジン添付ファイルプレビューが正しく開けます。",
            "@メンション候補は検索結果の並びが変わっても、ハイライト中の人または Issue を正しく選びます。",
            "キャンセル後に戻したチャット下書きは、削除して画面を移動しても復活しません。",
            "オートパイロットの初回起動、Issue ヘッダーのエージェント状態、Antigravity のプロバイダーエラー表示がより正確になりました。",
          ],
        },
        {
          version: "0.3.28",
