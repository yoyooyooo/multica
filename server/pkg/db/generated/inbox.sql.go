...
UPDATE inbox_item SET archived = true
WHERE id = $1
RETURNING id, workspace_id, recipient_type, recipient_id, type, severity, issue_id, title, body, read, archived, created_at, actor_type, actor_id, details, delivery_key
`
...
const createInboxItemWithDeliveryKey = `-- name: CreateInboxItemWithDeliveryKey :one
INSERT INTO inbox_item (
    workspace_id, recipient_type, recipient_id,
    type, severity, issue_id, title, body,
...
type CreateInboxItemWithDeliveryKeyParams struct {
	WorkspaceID   pgtype.UUID `json:"workspace_id"`
	RecipientType string      `json:"recipient_type"`
	RecipientID   pgtype.UUID `json:"recipient_id"`
	Type          string      `json:"type"`
...
func (q *Queries) CreateInboxItemWithDeliveryKey(ctx context.Context, arg CreateInboxItemWithDeliveryKeyParams) (InboxItem, error) {
	row := q.db.QueryRow(ctx, createInboxItemWithDeliveryKey,
		arg.WorkspaceID,
		arg.RecipientType,
		arg.RecipientID,
		arg.Type,
...
SELECT id, workspace_id, recipient_type, recipient_id, type, severity, issue_id, title, body, read, archived, created_at, actor_type, actor_id, details, delivery_key FROM inbox_item
WHERE id = $1
`
...
const getInboxItemByDeliveryKey = `-- name: GetInboxItemByDeliveryKey :one
SELECT id, workspace_id, recipient_type, recipient_id, type, severity, issue_id, title, body, read, archived, created_at, actor_type, actor_id, details, delivery_key FROM inbox_item
WHERE workspace_id = $1
...
type GetInboxItemByDeliveryKeyParams struct {
	WorkspaceID   pgtype.UUID `json:"workspace_id"`
	RecipientType string      `json:"recipient_type"`
	RecipientID   pgtype.UUID `json:"recipient_id"`
	DeliveryKey   pgtype.Text `json:"delivery_key"`
...
func (q *Queries) GetInboxItemByDeliveryKey(ctx context.Context, arg GetInboxItemByDeliveryKeyParams) (InboxItem, error) {
	row := q.db.QueryRow(ctx, getInboxItemByDeliveryKey,
		arg.WorkspaceID,
		arg.RecipientType,
		arg.RecipientID,
		arg.DeliveryKey,
...
SELECT i.id, i.workspace_id, i.recipient_type, i.recipient_id, i.type, i.severity, i.issue_id, i.title, i.body, i.read, i.archived, i.created_at, i.actor_type, i.actor_id, i.details, i.delivery_key,
