...
func TestWorkCoordinationBuiltinSkillBundle(t *testing.T) {
	...
	for _, required := range []string{"name: multica-work-coordination", "multica coordination scope ensure", "multica coordination scope get", "Work coordination scope is passive", "does not own scheduling"} {
