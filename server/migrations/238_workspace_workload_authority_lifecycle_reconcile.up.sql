-- Replace migration 236's temporary update-only member trigger after migration
-- 237 has installed the unique workspace authority index. The member lock and
