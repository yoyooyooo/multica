...
-- Migration 271 builds the workspace-id unique index concurrently and therefore
...
-- It updates only rows backfilled above; migration 272 atomically replaces it
