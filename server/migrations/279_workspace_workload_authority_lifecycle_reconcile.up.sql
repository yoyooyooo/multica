-- Replace migration 270's temporary update-only member trigger after migration
-- 271 has installed the unique workspace authority index. The member lock and
