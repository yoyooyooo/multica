...
-- Migration 230 builds the workspace-id unique index concurrently and therefore
...
-- It updates only rows backfilled above; migration 231 atomically replaces it
