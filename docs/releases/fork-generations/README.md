...
## Candidate generation (source replay in progress)

- **[`upstream-main-20260821`](upstream-main-20260821.md)** — owner-authorized freeze of `upstream/main@8f9c766e4` (nearest tag `v0.4.32`). Branch `fork/upstream-main-20260821`. Mini has **not** switched; do not treat this as live runtime authority until a deployment receipt exists.

## Active generation (single current formal home / live Mini)
